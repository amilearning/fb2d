"""Combined: pi(L2, replay) + B(l2, replay)
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill_combined/piL2_B_replay")
    ...
    wandb_run = maybe_init_wandb(args, "piL2+B", "l2", "replay")
    ...
    plt.suptitle(f"pi(L2,replay) + B(l2,replay)  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
