#!/usr/bin/env python3
"""Launch the combined π+X sweep: 24 configs × 3 seeds = 72 runs."""
import os, subprocess, time

HERE      = os.path.dirname(os.path.abspath(__file__))
FB2D      = os.path.dirname(HERE)
LOG_DIR   = os.path.join(HERE, "real_logs")
SAVE_ROOT = os.path.join(FB2D, "checkpoints_distill_combined_real")
...
log(f"starting combined sweep: {total} jobs, MAX_PARALLEL={MAX_PARALLEL}")
