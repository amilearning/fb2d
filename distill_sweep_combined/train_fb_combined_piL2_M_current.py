"""Combined: pi(L2, replay) + M(l2, current)
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill_combined/piL2_M_current")
    ...
    wandb_run = maybe_init_wandb(args, "piL2+M", "l2", "current")
    ...
    plt.suptitle(f"pi(L2,replay) + M(l2,current)  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
