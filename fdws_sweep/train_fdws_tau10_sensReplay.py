"""FDWS sweep: tau=1.0, sensitivity=replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_fdws_sweep/tau10_sensReplay")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws_tau10", "piGram+FBl2", "sensReplay")
    ...
    plt.suptitle(f"FDWS tau=1.0 sens=replay | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
