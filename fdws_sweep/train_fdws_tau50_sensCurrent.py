"""FDWS sweep: tau=5.0, sensitivity=current
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_fdws_sweep/tau50_sensCurrent")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws_tau50", "piGram+FBl2", "sensCurrent")
    ...
    plt.suptitle(f"FDWS tau=5.0 sens=current | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
