"""FDWS sweep: tau=0.5, sensitivity=replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_fdws_sweep/tau05_sensReplay")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws_tau05", "piGram+FBl2", "sensReplay")
    ...
    plt.suptitle(f"FDWS tau=0.5 sens=replay | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
