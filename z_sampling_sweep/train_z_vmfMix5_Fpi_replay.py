"""vMF mixture (K=5) + Fpi distill (piGram + F_l2, replay)
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_vmf_sweep/vmfMix5_Fpi_replay")
    ...
    wandb_run = maybe_init_wandb(args, "vmfMix5+Fpi", "l2+gram", "replay")
    ...
    plt.suptitle(f"vMF mix K=5 + Fpi(replay) — seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
