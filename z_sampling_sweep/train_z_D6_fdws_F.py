"""D6: z-sampling = FDWS (Fisher-weighted z-sampling) with sensitivity from F, distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/D6_fdws_F")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws", "piGram+FBl2", "D6")
    ...
    plt.suptitle(f"D6 | fdws_F | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
