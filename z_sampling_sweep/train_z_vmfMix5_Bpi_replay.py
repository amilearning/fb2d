"""vMF mixture (K=5) + Bpi distill (piGram + B_l2, replay)
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_vmf_sweep/vmfMix5_Bpi_replay")
    ...
    wandb_run = maybe_init_wandb(args, "vmfMix5+Bpi", "l2+gram", "replay")
    ...
    plt.suptitle(f"vMF mix K=5 + Bpi(replay) — seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
