"""D4: z-sampling = SMR (Sensitivity-Masked Routing) with sensitivity from pi, distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/D4_smr_pi")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "smr", "piGram+FBl2", "D4")
    ...
    plt.suptitle(f"D4 | smr_pi | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
