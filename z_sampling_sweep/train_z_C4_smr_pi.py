"""C4: z-sampling = SMR (Sensitivity-Masked Routing) with sensitivity from pi, distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/C4_smr_pi")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "smr", "no_distill", "C4")
    ...
    plt.suptitle(f"C4 | smr_pi | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
