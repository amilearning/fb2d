"""C6: z-sampling = FDWS (Fisher-weighted z-sampling) with sensitivity from F, distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/C6_fdws_F")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws", "no_distill", "C6")
    ...
    plt.suptitle(f"C6 | fdws_F | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
