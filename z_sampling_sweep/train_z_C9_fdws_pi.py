"""C9: z-sampling = FDWS (Fisher-weighted z-sampling) with sensitivity from pi, distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/C9_fdws_pi")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws", "no_distill", "C9")
    ...
    plt.suptitle(f"C9 | fdws_pi | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
