"""A1: z-sampling = vMF task-binding (z ~ vMF(mu_k, kappa) during stage k), distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/A1_vmf_bind")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "vmf_bind", "no_distill", "A1")
    ...
    plt.suptitle(f"A1 | vmf_bind | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
