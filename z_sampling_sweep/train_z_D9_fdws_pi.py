"""D9: z-sampling = FDWS (Fisher-weighted z-sampling) with sensitivity from pi, distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/D9_fdws_pi")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws", "piGram+FBl2", "D9")
    ...
    plt.suptitle(f"D9 | fdws_pi | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
