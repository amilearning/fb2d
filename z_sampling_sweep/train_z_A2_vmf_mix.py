"""A2: z-sampling = vMF non-task-binding (z ~ uniform mixture of all vMF components), distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/A2_vmf_mix")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "vmf_mix", "no_distill", "A2")
    ...
    plt.suptitle(f"A2 | vmf_mix | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
