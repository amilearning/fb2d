"""D5: z-sampling = SMR (Sensitivity-Masked Routing) with sensitivity from piFB, distillation = piGram_replay + FB_l2_replay
...
from z_sampling_lib import compute_z_sensitivity, smr_sample_z
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/D5_smr_piFB")
    ...
    p.add_argument("--smr_mask_ratio", type=float, default=0.5)
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "smr", "piGram+FBl2", "D5")
    ...
    plt.suptitle(f"D5 | smr_piFB | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
