"""C8: z-sampling = FDWS (Fisher-weighted z-sampling) with sensitivity from FB, distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/C8_fdws_FB")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws", "no_distill", "C8")
    ...
    plt.suptitle(f"C8 | fdws_FB | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
