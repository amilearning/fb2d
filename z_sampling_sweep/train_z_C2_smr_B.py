"""C2: z-sampling = SMR (Sensitivity-Masked Routing) with sensitivity from B, distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/C2_smr_B")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "smr", "no_distill", "C2")
    ...
    plt.suptitle(f"C2 | smr_B | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
