"""D7: z-sampling = FDWS (Fisher-weighted z-sampling) with sensitivity from B, distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/D7_fdws_B")
