"""D8: z-sampling = FDWS (Fisher-weighted z-sampling) with sensitivity from FB, distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/D8_fdws_FB")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws", "piGram+FBl2", "D8")
    ...
    plt.suptitle(f"D8 | fdws_FB | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
