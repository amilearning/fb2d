"""C1: z-sampling = SMR (Sensitivity-Masked Routing) with sensitivity from F, distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/C1_smr_F")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "smr", "no_distill", "C1")
    ...
    plt.suptitle(f"C1 | smr_F | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
