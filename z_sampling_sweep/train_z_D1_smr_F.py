"""D1: z-sampling = SMR (Sensitivity-Masked Routing) with sensitivity from F, distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/D1_smr_F")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "smr", "piGram+FBl2", "D1")
    ...
    plt.suptitle(f"D1 | smr_F | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
