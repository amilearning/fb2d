"""C5: z-sampling = SMR (Sensitivity-Masked Routing) with sensitivity from piFB, distillation = none
...
from distill_lib import (make_teacher, sample_z, joint_update, maybe_init_wandb, wandb_log, wandb_finish)
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/C5_smr_piFB")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "smr", "no_distill", "C5")
    ...
    plt.suptitle(f"C5 | smr_piFB | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
