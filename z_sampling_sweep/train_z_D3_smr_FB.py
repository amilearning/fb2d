"""D3: z-sampling = SMR (Sensitivity-Masked Routing) with sensitivity from FB, distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/D3_smr_FB")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "smr", "piGram+FBl2", "D3")
    ...
    plt.suptitle(f"D3 | smr_FB | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
