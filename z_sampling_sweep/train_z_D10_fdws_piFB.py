"""D10: z-sampling = FDWS (Fisher-weighted z-sampling) with sensitivity from piFB, distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/D10_fdws_piFB")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws", "piGram+FBl2", "D10")
    ...
    plt.suptitle(f"D10 | fdws_piFB | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
