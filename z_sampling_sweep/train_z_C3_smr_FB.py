"""C3: z-sampling = SMR (Sensitivity-Masked Routing) with sensitivity from FB, distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/C3_smr_FB")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "smr", "no_distill", "C3")
    ...
    plt.suptitle(f"C3 | smr_FB | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
