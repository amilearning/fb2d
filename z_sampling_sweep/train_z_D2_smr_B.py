"""D2: z-sampling = SMR (Sensitivity-Masked Routing) with sensitivity from B, distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/D2_smr_B")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "smr", "piGram+FBl2", "D2")
    ...
    plt.suptitle(f"D2 | smr_B | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
