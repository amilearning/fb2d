"""C10: z-sampling = FDWS (Fisher-weighted z-sampling) with sensitivity from piFB, distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/C10_fdws_piFB")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws", "no_distill", "C10")
    ...
    plt.suptitle(f"C10 | fdws_piFB | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
