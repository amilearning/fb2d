"""B2: z-sampling = vMF non-task-binding (z ~ uniform mixture of all vMF components), distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/B2_vmf_mix")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "vmf_mix", "piGram+FBl2", "B2")
    ...
    plt.suptitle(f"B2 | vmf_mix | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
