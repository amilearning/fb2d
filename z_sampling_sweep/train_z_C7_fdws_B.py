"""C7: z-sampling = FDWS (Fisher-weighted z-sampling) with sensitivity from B, distillation = none
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/C7_fdws_B")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "fdws", "no_distill", "C7")
    ...
    plt.suptitle(f"C7 | fdws_B | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
