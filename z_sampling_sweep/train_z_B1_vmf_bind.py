"""B1: z-sampling = vMF task-binding (z ~ vMF(mu_k, kappa) during stage k), distillation = piGram_replay + FB_l2_replay
...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_z_sampling/B1_vmf_bind")
    ...
    # W&B init
    wandb_run = maybe_init_wandb(args, "vmf_bind", "piGram+FBl2", "B1")
    ...
    plt.suptitle(f"B1 | vmf_bind | seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
