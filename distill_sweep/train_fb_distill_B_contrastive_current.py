...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/B_contrastive_current")
    ...
    wandb_run = maybe_init_wandb(args, "B", "contrastive", "current")
    ...
    plt.suptitle(f"Distill B  |  contrastive  |  current  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
