...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/M_cosine_replay")
    ...
    wandb_run = maybe_init_wandb(args, "M", "cosine", "replay")
    ...
    plt.suptitle(f"Distill M  |  cosine  |  replay  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
