...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/F_l2_replay")
    ...
    wandb_run = maybe_init_wandb(args, "F", "l2", "replay")
    ...
    plt.suptitle(f"Distill F  |  l2  |  replay  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
