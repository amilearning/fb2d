...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/pi_l2_current")
    ...
    wandb_run = maybe_init_wandb(args, "pi", "l2", "current")
    ...
    plt.suptitle(f"Distill pi  |  l2  |  current  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
