...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/M_l2_current")
    ...
    wandb_run = maybe_init_wandb(args, "M", "l2", "current")
    ...
    plt.suptitle(f"Distill M  |  l2  |  current  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
