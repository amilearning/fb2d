...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/pi_gram_replay")
    ...
    wandb_run = maybe_init_wandb(args, "pi", "gram", "replay")
    ...
    plt.suptitle(f"Distill pi  |  gram  |  replay  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
