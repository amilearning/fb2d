...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/pi_l2_replay")
    ...
    wandb_run = maybe_init_wandb(args, "pi", "l2", "replay")
    ...
    plt.suptitle(f"Distill pi  |  l2  |  replay  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
