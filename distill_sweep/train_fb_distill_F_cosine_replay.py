...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/F_cosine_replay")
    ...
    wandb_run = maybe_init_wandb(args, "F", "cosine", "replay")
    ...
    plt.suptitle(f"Distill F  |  cosine  |  replay  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
