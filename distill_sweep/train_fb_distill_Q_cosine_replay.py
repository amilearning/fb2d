...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/Q_cosine_replay")
    ...
    wandb_run = maybe_init_wandb(args, "Q", "cosine", "replay")
    ...
    plt.suptitle(f"Distill Q  |  cosine  |  replay  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
