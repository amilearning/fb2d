...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/Q_gram_current")
    ...
    wandb_run = maybe_init_wandb(args, "Q", "gram", "current")
    ...
    plt.suptitle(f"Distill Q  |  gram  |  current  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
