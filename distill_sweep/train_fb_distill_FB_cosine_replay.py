...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/FB_cosine_replay")
    ...
    wandb_run = maybe_init_wandb(args, "FB", "cosine", "replay")
    ...
    plt.suptitle(f"Distill FB  |  cosine  |  replay  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
