...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/F_gram_current")
    ...
    wandb_run = maybe_init_wandb(args, "F", "gram", "current")
    ...
    plt.suptitle(f"Distill F  |  gram  |  current  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
