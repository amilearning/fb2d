...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/FB_gram_replay")
    ...
    wandb_run = maybe_init_wandb(args, "FB", "gram", "replay")
    ...
    plt.suptitle(f"Distill FB  |  gram  |  replay  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
