...
def main():
    ...
    p.add_argument("--save_dir", default="checkpoints_distill/M_gram_current")
    ...
    wandb_run = maybe_init_wandb(args, "M", "gram", "current")
    ...
    plt.suptitle(f"Distill M  |  gram  |  current  —  seed{args.seed}",
                 fontsize=11, fontweight="bold")
    plt.tight_layout()
